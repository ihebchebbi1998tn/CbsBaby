...
const InterfaceListeControle = () => {
  ...
  const checklistItems = [
    ...
    {
      title: "Votre valise pour le séjour",
      description: "Préparez-vous avec des vêtements et vos essentiels.",
      image: require("../assets/Images/valise.png"),
    },
    {
      title: "Pour votre bébé",
      description: "Préparez tous les essentiels de votre bébé.",
