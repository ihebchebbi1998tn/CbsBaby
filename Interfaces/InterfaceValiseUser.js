...
const InterfaceValiseUser = () => {
  ...
  const documents = [
    { name: 'Tenues confortables pour allaitement' , icon: 'layers' },
    { name: 'Culottes ou slips jetables', icon: 'layers' },
    { name: 'Nécessaire de toilette corporelle', icon: 'layers' },
    { name: 'Coussinets pour seins', icon: 'layers' },
    { name: 'Garnitures maternité jetables', icon: 'layers' },
    { name: 'Soutien-gorge allaitement', icon: 'layers'},
    { name: 'Mules' ,   icon: 'layers' },
