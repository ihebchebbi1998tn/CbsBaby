...
const InterfaceValiseUser = () => {
  const navigation = useNavigation();
  const { t, i18n } = useTranslation(); // Access translation function
  const { user } = useContext(UserContext);

  const documents = [
    { name: 'Tenues confortables pour allaitement', translatedName: t('Valise.tenuesConfortables'), icon: 'layers' },
    { name: 'Culottes ou slips jetables', translatedName: t('Valise.culottesJetables'), icon: 'layers' },
    { name: 'Nécessaire de toilette corporelle', translatedName: t('Valise.necessaireToilette'), icon: 'layers' },
    { name: 'Coussinets pour seins', translatedName: t('Valise.coussinetsSeins'), icon: 'layers' },
    { name: 'Garnitures maternité jetables', translatedName: t('Valise.garnituresJetables'), icon: 'layers' },
    { name: 'Soutien-gorge allaitement', translatedName: t('Valise.soutienGorge'), icon: 'layers' },
    { name: 'Mules', translatedName: t('Valise.mules'), icon: 'layers' },
];
...
export default InterfaceValiseUser;
